...
class TestEncode(unittest.TestCase):
    ...
    def test_encode(self):
        ...
        self.assertEqual(encode(3.4028234663852886e+38).hex(), 'fb47efffffe0000000')
        self.assertEqual(encode(1.0e+300).hex(), 'fb7e37e43c8800759c')
        ...
        self.assertEqual(encode([1, [2, 3], [4, 5]]).hex(), '8301820203820406')
